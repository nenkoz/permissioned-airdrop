...
export const CampaignStatsCard: React.FC = () => {
    ...
    return (
        <Link to="/campaigns" className="block">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg hover:border-[#915bf8]/20 transition-all cursor-pointer group">
                <div className="mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 group-hover:text-[#915bf8] transition-colors">🎯 Platform Stats</h3>
                    <p className="text-gray-600">Live campaign overview</p>
                    <p className="text-sm text-[#915bf8] opacity-0 group-hover:opacity-100 transition-opacity mt-1">
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-purple-50/50 to-pink-50/50 rounded-lg p-6 border border-purple-100 group-hover:border-purple-200 transition-colors">
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border border-green-100 group-hover:border-green-200 transition-colors">
                            <div className="text-center">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-6 border border-blue-100 group-hover:border-blue-200 transition-colors">
                            <div className="text-center">
